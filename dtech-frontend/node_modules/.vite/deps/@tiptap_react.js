...
import { $ as getTextSerializersFromSchema, A as generateText, At as pasteRulesPlugin, B as getMarksBetween, Bt as wrappingInputRule, C as findChildrenInRange, Ct as markPasteRule, D as fromString, Dt as nodeInputRule, E as findParentNodeClosestToPos, Et as minMax, F as getExtensionField, Ft as selectionToInsertionEnd, G as getSchema, Gt as Plugin, H as getNodeAttributes, I as getHTMLFromFragment, It as splitExtensions, J as getSchemaTypeNameByName, K as getSchemaByResolvedExtensions, Kt as PluginKey, L as getMarkAttributes, Lt as textInputRule, M as getAttributesFromExtensions, Mt as removeDuplicates, N as getChangedRanges, Nt as resolveFocusPosition, O as generateHTML, Ot as nodePasteRule, P as getDebugJSON, Pt as rewriteUnknownContent, Q as getTextContentFromNodes, R as getMarkRange, Rt as textPasteRule, S as findChildren, St as markInputRule, T as findParentNode, Tt as mergeDeep, U as getNodeType, V as getNodeAtPosition, W as getRenderedAttributes, X as getText, Y as getSplittedAttributes, Z as getTextBetween, _ as createStyleTag, _t as isRegExp, a as Mark, at as isAtStartOfNode, b as elementFromString, bt as isTextSelection, c as NodeView, ct as isFunction, d as callOrReturn, dt as isMarkActive, et as index, f as canInsertNode, ft as isNodeActive, g as createNodeFromContent, gt as isPlainObject, h as createDocument, ht as isNumber, i as InputRule, it as isAtEndOfNode, j as getAttributes, jt as posToDOMRect, k as generateJSON, kt as objectIncludes, l as PasteRule, lt as isList, m as createChainableState, mt as isNodeSelection, n as Editor, nt as inputRulesPlugin, o as Node, ot as isEmptyObject, p as combineTransactionSteps, pt as isNodeEmpty, q as getSchemaTypeByName, r as Extension, rt as isActive, s as NodePos, st as isExtensionRulesEnabled, t as CommandManager, tt as injectExtensionAttributesToParseRule, u as Tracker, ut as isMacOS, v as defaultBlockAt, vt as isSafari, w as findDuplicates, wt as mergeAttributes, x as escapeForRegEx, xt as isiOS, y as deleteProps, yt as isString, z as getMarkType, zt as textblockTypeInputRule } from "./dist-BEwBsbE9.js";
var bottom = "bottom";
var right = "right";
var left = "left";
var auto = "auto";
...
var BubbleMenuView = class {
	constructor({ editor, element, view, tippyOptions = {}, updateDelay = 250, shouldShow }) {
		...
		this.blurHandler = ({ event }) => {
			...
			if ((event === null || event === void 0 ? void 0 : event.relatedTarget) && ((_a = this.element.parentNode) === null || _a === void 0 ? void 0 : _a.contains(event.relatedTarget))) return;
		...
		this.updateHandler = (view, selectionChanged, docChanged, oldState) => {
			...
			if (!((_a = this.shouldShow) === null || _a === void 0 ? void 0 : _a.call(this, {
				editor: this.editor,
			...
			(_b = this.tippy) === null || _b === void 0 || _b.setProps({ getReferenceClientRect: ((_c = this.tippyOptions) === null || _c === void 0 ? void 0 : _c.getReferenceClientRect) || (() => {
				if (isNodeSelection(state.selection)) {
					let node = view.nodeDOM(from);
					if (node) {
						const nodeViewWrapper = node.dataset.nodeViewWrapper ? node : node.querySelector("[data-node-view-wrapper]");
						if (nodeViewWrapper) node = nodeViewWrapper.firstChild;
	...
	createTooltip() {
		...
		if (this.tippy.popper.firstChild) this.tippy.popper.firstChild.addEventListener("blur", this.tippyBlurHandler);
	}
	...
	show() {
		var _a;
		(_a = this.tippy) === null || _a === void 0 || _a.show();
	}
	hide() {
		var _a;
		(_a = this.tippy) === null || _a === void 0 || _a.hide();
	}
	destroy() {
		var _a, _b;
		if ((_a = this.tippy) === null || _a === void 0 ? void 0 : _a.popper.firstChild) this.tippy.popper.firstChild.removeEventListener("blur", this.tippyBlurHandler);
		(_b = this.tippy) === null || _b === void 0 || _b.destroy();
...
var FloatingMenuView = class {
	...
	update(view, oldState) {
		...
		(_b = this.tippy) === null || _b === void 0 || _b.setProps({ getReferenceClientRect: ((_c = this.tippyOptions) === null || _c === void 0 ? void 0 : _c.getReferenceClientRect) || (() => posToDOMRect(view, from, to)) });
		this.show();
	}
	show() {
		var _a;
...
function requireUseSyncExternalStoreShim_development() {
	...
	(function() {
		...
		*/
		...
		useSyncExternalStoreShim_development.useSyncExternalStore = React$1.useSyncExternalStore !== void 0 ? React$1.useSyncExternalStore : shim;
...
function EditorProvider({ children, slotAfter, slotBefore, editorContainerProps = {}, ...editorOptions }) {
	...
	return import_react.createElement(EditorContext.Provider, { value: { editor } }, slotBefore, import_react.createElement(EditorConsumer, null, ({ editor: currentEditor }) => import_react.createElement(EditorContent, {
...
var BubbleMenu = (props) => {
	...
	(0, import_react.useEffect)(() => {
		var _a;
		if (!element) return;
		if (((_a = props.editor) === null || _a === void 0 ? void 0 : _a.isDestroyed) || (currentEditor === null || currentEditor === void 0 ? void 0 : currentEditor.isDestroyed)) return;
...
var ReactRenderer = class {
	...
	*/
	constructor(component, { editor, props = {}, as = "div", className = "" }) {
		...
		if (this.editor.isInitialized) (0, import_react_dom.flushSync)(() => {
			this.render();
		});
		else queueMicrotask(() => {
			this.render();
	...
	*/
	render() {
		...
		this.reactElement = import_react.createElement(Component, { ...elementProps });
		(_a = editor === null || editor === void 0 ? void 0 : editor.contentComponent) === null || _a === void 0 || _a.setRenderer(this.id, this);
	}
	/**
	...
	*/
	destroy() {
		var _a;
		const editor = this.editor;
		(_a = editor === null || editor === void 0 ? void 0 : editor.contentComponent) === null || _a === void 0 || _a.removeRenderer(this.id);
	}
	/**
...
var ReactNodeView = class extends NodeView {
	...
	*/
	mount() {
		...
		const ReactNodeViewProvider = (0, import_react.memo)((componentProps) => {
			return import_react.createElement(ReactNodeViewContext.Provider, { value: context }, (0, import_react.createElement)(Component, componentProps));
		});
	...
	*/
	get dom() {
		var _a;
		if (this.renderer.element.firstElementChild && !((_a = this.renderer.element.firstElementChild) === null || _a === void 0 ? void 0 : _a.hasAttribute("data-node-view-wrapper"))) throw Error("Please use the NodeViewWrapper component for your node view.");
	...
	*/
	update(node, decorations, innerDecorations) {
		...
		if (node === this.node && this.decorations === decorations && this.innerDecorations === innerDecorations) return true;
		this.node = node;
		this.decorations = decorations;
		this.innerDecorations = innerDecorations;
		rerenderComponent({
