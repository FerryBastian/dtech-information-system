...
function getSchema(extensions, editor) {
	return getSchemaByResolvedExtensions(ExtensionManager.resolve(extensions), editor);
}
/**
...
function getDebugJSON(node, startOffset = 0) {
	...
	if (node.content.childCount) {
		...
		node.forEach((child, offset) => {
			var _a;
			(_a = output.content) === null || _a === void 0 || _a.push(getDebugJSON(child, startOffset + offset + increment));
		});
	}
...
var NodeView = class {
	...
	onDragStart(event) {
		...
		(_g = event.dataTransfer) === null || _g === void 0 || _g.setDragImage(clonedNode, x, y);
	...
	stopEvent(event) {
		...
		const target = event.target;
		if (!(this.dom.contains(target) && !((_a = this.contentDOM) === null || _a === void 0 ? void 0 : _a.contains(target)))) return false;
...
//#endregion
export { getTextSerializersFromSchema as $, generateText as A, pasteRulesPlugin as At, getMarksBetween as B, wrappingInputRule as Bt, findChildrenInRange as C, markPasteRule as Ct, fromString as D, nodeInputRule as Dt, findParentNodeClosestToPos as E, minMax as Et, getExtensionField as F, selectionToInsertionEnd as Ft, getSchema as G, Plugin as Gt, getNodeAttributes as H, Decoration as Ht, getHTMLFromFragment as I, splitExtensions as It, getSchemaTypeNameByName as J, TextSelection as Jt, getSchemaByResolvedExtensions as K, PluginKey as Kt, getMarkAttributes as L, textInputRule as Lt, getAttributesFromExtensions as M, removeDuplicates as Mt, getChangedRanges as N, resolveFocusPosition as Nt, generateHTML as O, nodePasteRule as Ot, getDebugJSON as P, rewriteUnknownContent as Pt, getTextContentFromNodes as Q, Slice as Qt, getMarkRange as R, textPasteRule as Rt, findChildren as S, markInputRule as St, findParentNode as T, mergeDeep as Tt, getNodeType as U, DecorationSet as Ut, getNodeAtPosition as V, keydownHandler as Vt, getRenderedAttributes as W, NodeSelection as Wt, getText as X, dropPoint as Xt, getSplittedAttributes as Y, Mapping as Yt, getTextBetween as Z, Fragment as Zt, createStyleTag as _, isRegExp as _t, Mark as a, isAtStartOfNode as at, elementFromString as b, isTextSelection as bt, NodeView as c, isFunction as ct, callOrReturn as d, isMarkActive as dt, index as et, canInsertNode as f, isNodeActive as ft, createNodeFromContent as g, isPlainObject as gt, createDocument as h, isNumber as ht, InputRule as i, isAtEndOfNode as it, getAttributes as j, posToDOMRect as jt, generateJSON as k, objectIncludes as kt, PasteRule as l, isList as lt, createChainableState as m, isNodeSelection as mt, Editor as n, inputRulesPlugin as nt, Node as o, isEmptyObject as ot, combineTransactionSteps as p, isNodeEmpty as pt, getSchemaTypeByName as q, Selection as qt, Extension as r, isActive as rt, NodePos as s, isExtensionRulesEnabled as st, CommandManager as t, injectExtensionAttributesToParseRule as tt, Tracker as u, isMacOS as ut, defaultBlockAt as v, isSafari as vt, findDuplicates as w, mergeAttributes as wt, escapeForRegEx as x, isiOS as xt, deleteProps as y, isString as yt, getMarkType as z, textblockTypeInputRule as zt };

//# sourceMappingURL=dist-BEwBsbE9.js.map